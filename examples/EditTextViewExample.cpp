...
int main(int argc, char **argv) {
  ...
  CreateGLFWResources("EditTextView Example");
  ...
  EditTextView* textView = new EditTextView(windowRoot, "../fonts/Monospace.ttf", 30);
  Constraint* topConstraint = new Constraint(textView, BoxAttribute::Top, 
                                    Relation::EqualTo, windowRoot,
                                    BoxAttribute::Top, 1.f, 100.f);
  Constraint* bottomConstraint = new Constraint(textView, BoxAttribute::Bottom, 
                                    Relation::EqualTo, windowRoot,
                                    BoxAttribute::Bottom, 1.f, -100.f);
  ...
  windowRoot->AddConstraint(bottomConstraint);
